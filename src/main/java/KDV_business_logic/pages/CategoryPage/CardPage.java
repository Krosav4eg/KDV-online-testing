...
public class CardPage extends BasePage {
    ...
    public void validCardProductVerifyAdvantagesShop() {
        searchAndSelect();
        elementFluentWaitVisibility(productCardContainer).click();
        AssertCollector.assertTrue(getText(benefitDelivery).contains("Ваши покупки из интернет-магазина KDV по г. Томску мы доставим бесплатно. Доставка в день заказа, в удобное для вас время, до двери квартиры/офиса."));
